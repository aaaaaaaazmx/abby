package com.cl.common_base.widget.wheel;
...
public class WheelPicker<T> extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mCurtainColor = a.getColor(R.styleable.WheelPicker_wheelCurtainColor, Color.TRANSPARENT);
        ...
        fontTypefacePath = a.getString(R.styleable.WheelPicker_fontTypeface);
        a.recycle();
    }
    ...
    private void initPaint() {
        ...
        if (!TextUtils.isEmpty(fontTypefacePath)) {
            mTextPaint.setTypeface(Typeface.createFromAsset(getContext().getAssets(), fontTypefacePath));
        }
        ...
        if (!TextUtils.isEmpty(fontTypefacePath)) {
            mSelectedItemPaint.setTypeface(Typeface.createFromAsset(getContext().getAssets(), fontTypefacePath));
        }
...
//                }
            ...
            String drawText = (mDataFormat == null ? data.toString() : mDataFormat.format(data)) + (TextUtils.isEmpty(mIndicatorText) ? "" : " " + mIndicatorText);
            //在中间位置的Item作为被选中的。
        ...
        /*if (!TextUtils.isEmpty(mIndicatorText)) {
            canvas.drawText(mIndicatorText, mFirstItemDrawX + mTextMaxWidth / 2f + ResourceLoader.getDimen(getContext(), R.dimen.ry_px_10), mCenterItemDrawnY, mIndicatorPaint);
        }*/
    }
...
//                    computeDistanceToEndPoint(mScroller.getFinalY() % mItemHeight));
    ...
    public void setFontTypeface(Typeface fontTypeface) {
        ...
        mSelectedItemPaint.setTypeface(fontTypeface);
        mTextPaint.setTypeface(fontTypeface);
        postInvalidate();
    }
