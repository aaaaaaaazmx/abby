...
public class SwitchButton extends CompoundButton {
    ...
    public final float DEFAULT_THUMB_RANGE_RATIO = 1.9f;
    public final int DEFAULT_THUMB_SIZE_DP = 20;
    public final int DEFAULT_THUMB_MARGIN_DP = -5;
    public final int DEFAULT_ANIMATION_DURATION = 250;

    private int[] CHECKED_PRESSED_STATE = new int[]{android.R.attr.state_checked, android.R.attr.state_enabled, android.R.attr.state_pressed};
    private int[] UNCHECKED_PRESSED_STATE = new int[]{-android.R.attr.state_checked, android.R.attr.state_enabled, android.R.attr.state_pressed};
    ...
    private void init(AttributeSet attrs) {
        ...
        if (ta != null) {
            ...
            if (thumbDrawable == null) {
                thumbDrawable = ContextCompat.getDrawable(getContext(), R.mipmap.ic_thumb);
            }
...
//            } else {
                mTintColor = ContextCompat.getColor(getContext(), R.color.mainColor);
//            }
        }
    ...
    private ColorStateList generateBackColorWithTintColor(final int tintColor) {
        ...
        int[] colors = new int[]{
                ...
                0x20000000,
                mIsThumbUseDrawable ? tintColor : tintColor - 0xD0000000,
                0x20000000
        };
        return new ColorStateList(states, colors);
    }
