...
import com.hyphenate.helpdesk.easeui.ui.IconTextView;
...
public class ChatRowText extends ChatRow{
    ...
    public void onSetUpView() {
        ...
        contentView.setTextColor(message.direct() == Message.Direct.RECEIVE ? Color.BLACK : Color.WHITE);
        contentView.setLinkTextColor(Color.parseColor("#CC6082"));
        handleTextMessage();
    }
