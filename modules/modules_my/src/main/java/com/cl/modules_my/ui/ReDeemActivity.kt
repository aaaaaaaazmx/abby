                ...
                success {
                    ...
                    pop.asCustom(
                        BaseCenterPop(
                            ...
                            content = if (data?.month == "1") getString(com.cl.common_base.R.string.string_month, "${data?.month}") else getString(com.cl.common_base.R.string.string_months, "${data?.month}"),
