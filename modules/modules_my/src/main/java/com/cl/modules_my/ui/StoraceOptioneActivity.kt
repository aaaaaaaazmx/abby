    ...
    override fun initData() {
        ...
        binding.btnSuccess.setOnClickListener {
            ...
            if (binding.curingBox.isChecked) {
                ...
                mViewModel.cameraSetting(UpdateInfoReq(deviceId = deviceId, storageModel = 0, relationId = relationId))
            } else {
                //  选中了存储到云端 然后返回 onBackPressed
                mViewModel.cameraSetting(UpdateInfoReq(deviceId = deviceId, storageModel = 1, relationId = relationId))
            }
        }
    }
}